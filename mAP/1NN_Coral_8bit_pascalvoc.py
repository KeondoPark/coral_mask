...
parser.add_argument(
    ...
    '--detfolder',
    dest='detFolder',
    default=os.path.join(currentPath, '1NN_Coral_8bit_detections'), # 'detections'
    metavar='',
...
if ValidateMandatoryArgs(args.detFolder, '-det/--detfolder', errors):
    ...
    # errors.pop()
    detFolder = os.path.join(currentPath, '1NN_Coral_8bit_detections') # 'detections'
...
if args.savePath is not None:
    ...
    savePath = os.path.join(currentPath, '1NN_Coral_8bit_results') # 'results'
# Validate savePath
